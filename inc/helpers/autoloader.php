...
namespace ASTRO_THEME\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( ASTRO_DIR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\ASTRO_THEME\Inc\Helpers\autoloader' );